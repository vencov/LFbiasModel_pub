%script to use for repeatedly calling the function Sim2ToneCDQD
...
for j=1:Nlevel
    ...
    for i=1:NOPo
            ...
            [tim,x,oaeFdp,oaeFdp2,oaeF1,oaeF2,oaeStFdp,oaeStFdp2,oaeStF1,oaeStF2,...
             ...
             TMdispF1,TMdispF2,UUr1Fdp,UUr1Fdp2,UUr1F1,UUr1F2] = Sim2ToneCDQD(A1o(j),F1o,A2o(j),F2o,gain,phi1o,...
