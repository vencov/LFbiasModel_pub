function [tim,x,oaeFdp,oaeFdp2,oaeF1,oaeF2,oaeStFdp,oaeStFdp2,oaeStF1,oaeStF2,...
    ...
    TMdispF1,TMdispF2,UUr1Fdp,UUr1Fdp2,UUr1F1,UUr1F2] = Sim2ToneCDQDBF1(A1o,F1o,A2o,F2o,gain,phi1o,...
    phi2o,T12ono,visual,TMres,faca0,facb0,OPo)
%simulation for one combination L1,L2,F1,F2, second order BF, 
%calls "CochleaRGB_Tone_AVDissertace_Tone2BF2"
...
if nargin<13,OPo=0;end  %OP shift
  ...
  [oae,tim,x,RR,UU,UUr,oaeSt,TMdisp,UUr1]=CochleaRGB_Tone_AVDisertace_Tone2BF1(A1o,F1o,A2o,F2o,gain,phi1o,phi2o,T12ono,visual,TMres,faca0,facb0,OPo);
