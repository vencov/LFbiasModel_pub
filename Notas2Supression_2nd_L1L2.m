% Code for LF biasing
% parameters like duration of the LF bias tone can be changed in
% CochleaRGB_Tone_AVDisertace_Tone3N_OP.m

clear all
close all
A1o=65; %[50:5:70]; %[dB SPL]  % L1 tone level
F1o=2176;%[Hz]
A2o=60; %[dB SPL]   % L2 tone level
F2o=2688; %[Hz]
phi1o=0;
phi2o=0;
T12ono=0.05;
...
Fs=204.8E3;
A3o=[100:2:130];
A3o = [90:5:120]  % LF bias tone levels

%A3o = 115
F3o=32;% 25, 32, 50, 75, and 100 [Hz]   % bias tone frequency
phi3o=-pi/2;
...
for i=1:length(A3o)
    ...
    phi1o = 0
    phi2o = 0
    [oae1,tim,x,RR1,UU1,UUr1,oaeSt1,TMdisp1,UUr1]=CochleaRGB_Tone_AVDisertace_Tone3N_OP(A1o,F1o,A2o,F2o,gain,phi1o,phi2o,T12ono,visual,TMres,A3o(i),F3o,phi3o,T3ono,faca,facb,OPs);
    %dpoaeL1v = 20*log10(abs(fft(oae1(end-3199:end))));
    %dpoaeL1(i) = dpoaeL1v(27);
    %
    phi1o = pi/2
    phi2o = pi
    ...
    save(['PhNewAnDPOAE_OP0_65_60_' num2str(A3o(i)) '.mat'], 'oae1', 'oae2','oae3', 'oae4', 'tim', 'RR1', 'RR2', 'RR3', 'RR4', 'F3o','TMdisp1','TMdisp2','TMdisp3','TMdisp4')
    %save(['bDPOAE_OP0_32_60_50_' num2str(A3o(i)) '.mat'], 'oae', 'tim', 'RR','F3o','TMdisp','UUr1','UUr','UU')
