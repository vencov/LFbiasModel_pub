...
phi3o=-pi/2;
T3ono=0.1;  % ramp for LF bias tone, onset
...
for i=1:length(A3o)
    ...
    phi1o = 0
    phi2o = 0
    [oae1,tim,x,RR1,UU1,UUr1,oaeSt1,TMdisp1,UUrC1]=CochleaRGB_Tone_AVDisertace_Tone3N_OP1st(A1o,F1o,A2o,F2o,gain,phi1o,phi2o,T12ono,visual,TMres,A3o(i),F3o,phi3o,T3ono,faca,facb,OPs);
    phi1o = pi/2
    phi2o = pi
    [oae2,tim,x,RR2,UU2,UUr2,oaeSt2,TMdisp2,UUrC2]=CochleaRGB_Tone_AVDisertace_Tone3N_OP1st(A1o,F1o,A2o,F2o,gain,phi1o,phi2o,T12ono,visual,TMres,A3o(i),F3o,phi3o,T3ono,faca,facb,OPs);
    phi1o = pi
    phi2o = 0
    [oae3,tim,x,RR3,UU3,UUr3,oaeSt3,TMdisp3,UUrC3]=CochleaRGB_Tone_AVDisertace_Tone3N_OP1st(A1o,F1o,A2o,F2o,gain,phi1o,phi2o,T12ono,visual,TMres,A3o(i),F3o,phi3o,T3ono,faca,facb,OPs);
    phi1o = 3/2*pi
    phi2o = pi
    [oae4,tim,x,RR4,UU4,UUr4,oaeSt4,TMdisp4,UUrC4]=CochleaRGB_Tone_AVDisertace_Tone3N_OP1st(A1o,F1o,A2o,F2o,gain,phi1o,phi2o,T12ono,visual,TMres,A3o(i),F3o,phi3o,T3ono,faca,facb,OPs);
    ...
    save(['PhNewAn1stDPOAE_OP0_96_65_60_' num2str(A3o(i)) '.mat'], 'oae1', 'oae2','oae3', 'oae4', 'tim', 'RR1', 'RR2', 'RR3', 'RR4', 'F3o','TMdisp1','TMdisp2','TMdisp3','TMdisp4','UUrC1','UUrC2','UUrC3','UUrC4')
