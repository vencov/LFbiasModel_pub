...
OPo=[OPo,0,-OPo(end:-1:1)];

load ../Data/DPOAEOPL140L240V3sym oaeFdp2a oaeFdpa
oaeFdp2a40=oaeFdp2a;
oaeFdpa40=oaeFdpa;
oaeFdpa40N= oaeFdpa40/max(oaeFdpa40);
oaeFdp2a40N= oaeFdp2a40/max(oaeFdp2a40);

load ../Data/DPOAEOPL145L245V3sym oaeFdp2a oaeFdpa
oaeFdp2a45=oaeFdp2a;
oaeFdpa45=oaeFdpa;
...
nexttile
hold on;
%plot(OPo,oaeFdpa40,'color',line_colors(1,:),'linewidth',lw);
%plot(OPo,oaeFdpa45,'color',line_colors(2,:),'linewidth',lw);
...
%% === Export do JPG ===
exportgraphics(gcf,'Figures/Figure08.jpg', 'resolution', 600);
