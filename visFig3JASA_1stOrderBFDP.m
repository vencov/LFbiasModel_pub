...
pos(4) = pos(4) - 0.03;       % Shift to the right (increase the 'left' value)
pos(2) = pos(2) + 0.04;       % Shift to the right (increase the 'left' value)
...
% === Export ===
exportgraphics(gcf,'Figures/Figure03.jpg', 'resolution', 600);
